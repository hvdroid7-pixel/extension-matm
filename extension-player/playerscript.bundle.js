...
const sprint = { max: 100, value: 100, draining: false, exhausted: false, regenRate: 4, drainRate: 12 };
...
function createStyles(){
  ...
  const css = `
    :root { --flee-border: ${custom.border}; --flee-text: ${custom.text}; }
...
function initAll(){
  ...
  setupPonyTownProfileObserver();
  setupPonyBoxButtonsObserver();
